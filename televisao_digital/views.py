...
from televisao_digital.serializers import EstacaoSerializer
...
class APIRoot(AbstractResource):
    ...
    def get_entry_point_data(self, request, *args, **kwargs):
        return {
            "estacoes": reverse("televisao_digital:Estacao_list", args=args, kwargs=kwargs, request=request),
        }
...
class EstacaoList(FeatureCollectionResource):
    serializer_class = EstacaoSerializer

class EstacaoDetail(FeatureResource):
    serializer_class = EstacaoSerializer